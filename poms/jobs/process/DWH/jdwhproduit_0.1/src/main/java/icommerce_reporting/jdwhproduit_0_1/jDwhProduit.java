...
/**
 * Job: jDwhProduit Purpose: Alimentation de la table DIM_PRODUIT<br>
 * Description: Alimentation de la table DIM_PRODUIT <br>
 * @author 
...
public static class insertNewProductsStruct implements routines.system.IPersistableRow<insertNewProductsStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jDwhProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jDwhProduit = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(insertNewProductsStruct other) {
...
insertNewProductsStruct insertNewProducts = new insertNewProductsStruct();
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?)";
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"DT_MISE_A_JOUR\" = ?,\"BL_LIGNE_ACTIVE\" = ? WHERE \"ID_DIM_PRODUIT\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertNewProducts");
					}
...
int count_tDBOutput_3=0;
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?)";
...
insertNewProductsStruct insertNewProducts_tmp = new insertNewProductsStruct();
// ###############################
...
updateBlCurrent_tmp.ID_DIM_PRODUIT = row3.ID_DIM_PRODUIT ;
...
// # Output table : 'insertNewProducts'
// # Filter conditions 
if( 
...
insertNewProducts_tmp.CD_PRODUIT = produits.CD_PRODUIT  ;
insertNewProducts_tmp.NOM_PRODUIT = produits.NOM_PRODUIT  ;
insertNewProducts_tmp.CD_SOUS_CATEGORIE = produits.CD_SOUS_CATEGORIE  ;
insertNewProducts_tmp.LB_SOUS_CATEGORIE = produits.LB_SOUS_CATEGORIE  ;
insertNewProducts_tmp.CD_CATEGORIE = produits.CD_CATEGORIE  ;
insertNewProducts_tmp.LB_CATEGORIE = produits.LB_CATEGORIE  ;
insertNewProducts_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertNewProducts_tmp.BL_LIGNE_ACTIVE = 1 ;
insertNewProducts_tmp.LB_JOB_NAME = produits.LB_JOB_NAME ;
insertNewProducts = insertNewProducts_tmp;
} // closing filter/reject
...
} else {pstmt_tDBOutput_1.setString(3, insertProduit.CD_SOUS_CATEGORIE);
}

                    if(insertProduit.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, insertProduit.LB_SOUS_CATEGORIE);
}

                    if(insertProduit.CD_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, insertProduit.CD_CATEGORIE);
}

                    if(insertProduit.LB_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, insertProduit.LB_CATEGORIE);
}

                    if(insertProduit.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(insertProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(8, insertProduit.BL_LIGNE_ACTIVE);

                    if(insertProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, insertProduit.LB_JOB_NAME);
}
...
pstmt_tDBOutput_2.setNull(1, java.sql.Types.TIMESTAMP);
                    ...
                    pstmt_tDBOutput_2.setInt(3 + count_tDBOutput_2, updateBlCurrent.ID_DIM_PRODUIT);
...
// Start of branch "insertNewProducts"
if(insertNewProducts != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(insertNewProducts.CD_PRODUIT == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, insertNewProducts.CD_PRODUIT);
}

                    if(insertNewProducts.NOM_PRODUIT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertNewProducts.NOM_PRODUIT);
}

                    if(insertNewProducts.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertNewProducts.CD_SOUS_CATEGORIE);
}

                    if(insertNewProducts.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, insertNewProducts.LB_SOUS_CATEGORIE);
}

                    if(insertNewProducts.CD_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, insertNewProducts.CD_CATEGORIE);
}

                    if(insertNewProducts.LB_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, insertNewProducts.LB_CATEGORIE);
}

                    if(insertNewProducts.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(insertNewProducts.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(8, insertNewProducts.BL_LIGNE_ACTIVE);

                    if(insertNewProducts.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, insertNewProducts.LB_JOB_NAME);
}
...
} // End of branch "insertNewProducts"
...
globalMap.put("tDBOutput_3_ERROR_MESSAGE",e_tDBOutput_3.getMessage());
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertNewProducts");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(produits,row3) outputs:(insertProduit,updateBlCurrent,insertNewProducts)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    while (rs_tDBInput_3.next()) {
		        nb_line_tDBInput_3++;
							...
							if(colQtyInRs_tDBInput_3 < 1) {
								row3.ID_DIM_PRODUIT = null;
							} else {
		                          
            row3.ID_DIM_PRODUIT = rs_tDBInput_3.getInt(1);
        	...
        	row3.CD_PRODUIT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row3.NOM_PRODUIT = null;
							} else {
	                         		
        	row3.NOM_PRODUIT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row3.PRIX_ACHAT_PRODUIT = null;
							} else {
		                          
            row3.PRIX_ACHAT_PRODUIT = rs_tDBInput_3.getBigDecimal(4);
            if(rs_tDBInput_3.wasNull()){
                    row3.PRIX_ACHAT_PRODUIT = null;
            }
		                    }
            ...
            row3.PRIX_VENTE_PRODUIT = rs_tDBInput_3.getBigDecimal(5);
            if(rs_tDBInput_3.wasNull()){
                    row3.PRIX_VENTE_PRODUIT = null;
            }
		                    }
        	...
        	row3.CD_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row3.LB_SOUS_CATEGORIE = null;
							} else {
	                         		
        	row3.LB_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 7, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 8) {
								row3.CD_CATEGORIE = null;
							} else {
	                         		
        	row3.CD_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 8, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 9) {
								row3.LB_CATEGORIE = null;
							} else {
	                         		
        	row3.LB_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 9, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 10) {
								row3.DT_INSERTION = null;
							} else {
										
			row3.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 10);
		                    }
							if(colQtyInRs_tDBInput_3 < 11) {
								row3.DT_MISE_A_JOUR = null;
							} else {
										
			row3.DT_MISE_A_JOUR = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 11);
		                    }
							if(colQtyInRs_tDBInput_3 < 12) {
								row3.BL_LIGNE_ACTIVE = null;
							} else {
		                          
            row3.BL_LIGNE_ACTIVE = rs_tDBInput_3.getInt(12);
            if(rs_tDBInput_3.wasNull()){
                    row3.BL_LIGNE_ACTIVE = null;
            }
		                    }
        	...
        	row3.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 13, false);
		                    }
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
        	...
        	row4.CD_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_4, 1, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row4.LB_CATEGORIE = null;
							} else {
	                         		
        	row4.LB_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row4.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row4.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								row4.DT_INSERTION = null;
							} else {
										
			row4.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 4);
		                    }
							if(colQtyInRs_tDBInput_4 < 5) {
								row4.BL_LIGNE_ACTIVE = 0;
							} else {
		                          
            row4.BL_LIGNE_ACTIVE = rs_tDBInput_4.getInt(5);
        	...
        	row4.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_4, 6, false);
		                    }
...
/************************************************************************************************
 *     277453 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:44:04 WAT
 ************************************************************************************************/