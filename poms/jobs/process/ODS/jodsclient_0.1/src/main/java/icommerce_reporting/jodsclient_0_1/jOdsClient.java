...
/**
 * Job: jOdsClient Purpose: Alimenter la table ODS_CLIENT<br>
 * Description: Alimenter la table ODS_CLIENT <br>
...
public static class insertClientStruct implements routines.system.IPersistableRow<insertClientStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertClientStruct other = (insertClientStruct) obj;
	...
	public void copyDataTo(insertClientStruct other) {
	...
	public void copyKeysDataTo(insertClientStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertClientStruct other) {
...
public static class insertNewValueClientStruct implements routines.system.IPersistableRow<insertNewValueClientStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertNewValueClientStruct other = (insertNewValueClientStruct) obj;
	...
	public void copyDataTo(insertNewValueClientStruct other) {
	...
	public void copyKeysDataTo(insertNewValueClientStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertNewValueClientStruct other) {
...
public static class VerifTypeClientStruct implements routines.system.IPersistableRow<VerifTypeClientStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(VerifTypeClientStruct other) {
...
public static class TypeClientManquantStruct implements routines.system.IPersistableRow<TypeClientManquantStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final TypeClientManquantStruct other = (TypeClientManquantStruct) obj;
	...
	public void copyDataTo(TypeClientManquantStruct other) {
	...
	public void copyKeysDataTo(TypeClientManquantStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(TypeClientManquantStruct other) {
...
VerifTypeClientStruct VerifTypeClient = new VerifTypeClientStruct();
insertClientStruct insertClient = new insertClientStruct();
updateBlCurrentStruct updateBlCurrent = new updateBlCurrentStruct();
insertNewValueClientStruct insertNewValueClient = new insertNewValueClientStruct();
TypeClientManquantStruct TypeClientManquant = new TypeClientManquantStruct();
...
insertRejectStruct insertReject = new insertRejectStruct();
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertClient");
					}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"ID_CLIENT\",\"NOM_CLIENT\",\"PREN_CLIENT\",\"CD_POSTAL_CLIENT\",\"VILLE_CLIENT\",\"PAYS_CLIENT\",\"REGION_CLIENT\",\"CD_TYPE_CLIENT\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"BL_LIGNE_ACTIVE\" = ? WHERE \"ID_CLIENT\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertNewValueClient");
					}
...
if(dbschema_tDBOutput_6 == null || dbschema_tDBOutput_6.trim().length() == 0) {
	tableName_tDBOutput_6 = ("ODS_CLIENT");
} else {
	tableName_tDBOutput_6 = dbschema_tDBOutput_6 + "\".\"" + ("ODS_CLIENT");
}
...
int count_tDBOutput_6=0;
	    String insert_tDBOutput_6 = "INSERT INTO \"" + tableName_tDBOutput_6 + "\" (\"ID_CLIENT\",\"NOM_CLIENT\",\"PREN_CLIENT\",\"CD_POSTAL_CLIENT\",\"VILLE_CLIENT\",\"PAYS_CLIENT\",\"REGION_CLIENT\",\"CD_TYPE_CLIENT\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tMap_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"VerifTypeClient");
					}
...
insertClientStruct insertClient_tmp = new insertClientStruct();
updateBlCurrentStruct updateBlCurrent_tmp = new updateBlCurrentStruct();
insertNewValueClientStruct insertNewValueClient_tmp = new insertNewValueClientStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"TypeClientManquant");
					}
...
// ###############################
// # Outputs initialization
VerifTypeClientStruct VerifTypeClient_tmp = new VerifTypeClientStruct();
TypeClientManquantStruct TypeClientManquant_tmp = new TypeClientManquantStruct();
// ###############################
...
if(Clients != null) { 
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
      ope_tFilterRow_2.matches((// code sample : use Clients to define the condition.
// Clients.columnName1.equals("foo") ||!(Clients.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
!Clients.ID_CLIENT.isEmpty() && 
...
VerifTypeClient = null;
TypeClientManquant = null;

if(!rejectedInnerJoin_tMap_2 ) {

// # Output table : 'VerifTypeClient'
VerifTypeClient_tmp.ID_CLIENT = row3.ID_CLIENT ;
VerifTypeClient_tmp.NOM_CLIENT = row3.NOM_CLIENT ;
VerifTypeClient_tmp.PREN_CLIENT = row3.PREN_CLIENT ;
VerifTypeClient_tmp.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT ;
VerifTypeClient_tmp.VILLE_CLIENT = row3.VILLE_CLIENT ;
VerifTypeClient_tmp.PAYS_CLIENT = row3.PAYS_CLIENT ;
VerifTypeClient_tmp.REGION_CLIENT = row3.REGION_CLIENT ;
VerifTypeClient_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
VerifTypeClient_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
VerifTypeClient = VerifTypeClient_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'TypeClientManquant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
TypeClientManquant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
TypeClientManquant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
TypeClientManquant_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
TypeClientManquant_tmp.LB_LIGNE_REJET = row3.ID_CLIENT+"|"+row3.NOM_CLIENT+"|"+row3.PREN_CLIENT+"|"+row3.CD_POSTAL_CLIENT+"|"+row3.VILLE_CLIENT+"|"+row3.PAYS_CLIENT+"|"+row3.REGION_CLIENT+"|"+row3.CD_TYPE_CLIENT ;
TypeClientManquant_tmp.LB_MESSAGE_REJET = "Dépendance ==> Le type_client : "+row3.CD_TYPE_CLIENT+" n'existe pas dans la table ODS_TYPE_CLIENT" ;
TypeClientManquant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
TypeClientManquant_tmp.DT_REJET = TalendDate.getCurrentDate() ;
TypeClientManquant_tmp.LB_JOB_NAME = jobName;
TypeClientManquant = TypeClientManquant_tmp;
 ...
 */
// Start of branch "VerifTypeClient"
if(VerifTypeClient != null) { 
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.ID_CLIENT = VerifTypeClient.ID_CLIENT ;
...
!VerifTypeClient.NOM_CLIENT.equals(row7.NOM_CLIENT) ||
!VerifTypeClient.PREN_CLIENT.equals(row7.PREN_CLIENT) ||
!VerifTypeClient.CD_POSTAL_CLIENT.equals(row7.CD_POSTAL_CLIENT) ||
!VerifTypeClient.VILLE_CLIENT.equals(row7.VILLE_CLIENT) ||
!VerifTypeClient.PAYS_CLIENT.equals(row7.PAYS_CLIENT) ||
!VerifTypeClient.REGION_CLIENT.equals(row7.REGION_CLIENT) ||
!VerifTypeClient.CD_TYPE_CLIENT.equals(row7.CD_TYPE_CLIENT)

 ) {
updateBlCurrent_tmp.ID_CLIENT = row7.ID_CLIENT ;
updateBlCurrent_tmp.BL_LIGNE_ACTIVE = 0;
updateBlCurrent = updateBlCurrent_tmp;
} // closing filter/reject

// # Output table : 'insertNewValueClient'
// # Filter conditions 
if( 
...
insertNewValueClient_tmp.ID_CLIENT = VerifTypeClient.ID_CLIENT ;
insertNewValueClient_tmp.NOM_CLIENT = VerifTypeClient.NOM_CLIENT ;
insertNewValueClient_tmp.PREN_CLIENT = VerifTypeClient.PREN_CLIENT ;
insertNewValueClient_tmp.CD_POSTAL_CLIENT = VerifTypeClient.CD_POSTAL_CLIENT ;
insertNewValueClient_tmp.VILLE_CLIENT = VerifTypeClient.VILLE_CLIENT ;
insertNewValueClient_tmp.PAYS_CLIENT = VerifTypeClient.PAYS_CLIENT ;
insertNewValueClient_tmp.REGION_CLIENT = VerifTypeClient.REGION_CLIENT ;
insertNewValueClient_tmp.CD_TYPE_CLIENT = VerifTypeClient.CD_TYPE_CLIENT ;
insertNewValueClient_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertNewValueClient_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertNewValueClient_tmp.BL_LIGNE_ACTIVE = 1;
insertNewValueClient_tmp.LB_JOB_NAME = jobName;
insertNewValueClient = insertNewValueClient_tmp;
} // closing filter/reject
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'insertClient'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
insertClient_tmp.ID_CLIENT = VerifTypeClient.ID_CLIENT ;
insertClient_tmp.NOM_CLIENT = VerifTypeClient.NOM_CLIENT ;
insertClient_tmp.PREN_CLIENT = VerifTypeClient.PREN_CLIENT ;
insertClient_tmp.CD_POSTAL_CLIENT = VerifTypeClient.CD_POSTAL_CLIENT ;
insertClient_tmp.VILLE_CLIENT = VerifTypeClient.VILLE_CLIENT ;
insertClient_tmp.PAYS_CLIENT = VerifTypeClient.PAYS_CLIENT ;
insertClient_tmp.REGION_CLIENT = VerifTypeClient.REGION_CLIENT ;
insertClient_tmp.CD_TYPE_CLIENT = VerifTypeClient.CD_TYPE_CLIENT ;
insertClient_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertClient_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertClient_tmp.BL_LIGNE_ACTIVE = 1;
insertClient_tmp.LB_JOB_NAME = jobName;
insertClient = insertClient_tmp;
} // closing filter/reject
// ###############################
...
if(insertClient != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(insertClient.ID_CLIENT == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, insertClient.ID_CLIENT);
}

                    if(insertClient.NOM_CLIENT == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertClient.NOM_CLIENT);
}

                    if(insertClient.PREN_CLIENT == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, insertClient.PREN_CLIENT);
}

                    if(insertClient.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, insertClient.CD_POSTAL_CLIENT);
}

                    if(insertClient.VILLE_CLIENT == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, insertClient.VILLE_CLIENT);
}

                    if(insertClient.PAYS_CLIENT == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, insertClient.PAYS_CLIENT);
}

                    if(insertClient.REGION_CLIENT == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, insertClient.REGION_CLIENT);
}

                    if(insertClient.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, insertClient.CD_TYPE_CLIENT);
}

                    if(insertClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, insertClient.LB_NOM_FICHIER);
}

                    if(insertClient.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(10, new java.sql.Timestamp(insertClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(11, insertClient.BL_LIGNE_ACTIVE);

                    if(insertClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(12, insertClient.LB_JOB_NAME);
}
...
if(updateBlCurrent != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    ...
                    if(updateBlCurrent.ID_CLIENT == null) {
pstmt_tDBOutput_3.setNull(2 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2 + count_tDBOutput_3, updateBlCurrent.ID_CLIENT);
}
...
// Start of branch "insertNewValueClient"
if(insertNewValueClient != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(insertNewValueClient.ID_CLIENT == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, insertNewValueClient.ID_CLIENT);
}

                    if(insertNewValueClient.NOM_CLIENT == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, insertNewValueClient.NOM_CLIENT);
}

                    if(insertNewValueClient.PREN_CLIENT == null) {
pstmt_tDBOutput_6.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(3, insertNewValueClient.PREN_CLIENT);
}

                    if(insertNewValueClient.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, insertNewValueClient.CD_POSTAL_CLIENT);
}

                    if(insertNewValueClient.VILLE_CLIENT == null) {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(5, insertNewValueClient.VILLE_CLIENT);
}

                    if(insertNewValueClient.PAYS_CLIENT == null) {
pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(6, insertNewValueClient.PAYS_CLIENT);
}

                    if(insertNewValueClient.REGION_CLIENT == null) {
pstmt_tDBOutput_6.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(7, insertNewValueClient.REGION_CLIENT);
}

                    if(insertNewValueClient.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_6.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(8, insertNewValueClient.CD_TYPE_CLIENT);
}

                    if(insertNewValueClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(9, insertNewValueClient.LB_NOM_FICHIER);
}

                    if(insertNewValueClient.DT_INSERTION != null) {
pstmt_tDBOutput_6.setTimestamp(10, new java.sql.Timestamp(insertNewValueClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_6.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_6.setInt(11, insertNewValueClient.BL_LIGNE_ACTIVE);

                    if(insertNewValueClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_6.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(12, insertNewValueClient.LB_JOB_NAME);
}
...
} // End of branch "insertNewValueClient"
...
} // End of branch "VerifTypeClient"




// Start of branch "TypeClientManquant"
if(TypeClientManquant != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(TypeClientManquant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, TypeClientManquant.LB_CHEMIN_FICHIER);
}

                    if(TypeClientManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, TypeClientManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_1.setInt(3, TypeClientManquant.NUM_LIGNE_REJET);

                    if(TypeClientManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, TypeClientManquant.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(TypeClientManquant.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, TypeClientManquant.LB_MESSAGE_REJET);
}

                        if(TypeClientManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, TypeClientManquant.LB_NOM_FLUX);
}

                        if(TypeClientManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(TypeClientManquant.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(TypeClientManquant.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, TypeClientManquant.LB_JOB_NAME);
}

                        if(TypeClientManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, TypeClientManquant.LB_CHEMIN_FICHIER);
}

                        if(TypeClientManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, TypeClientManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1, TypeClientManquant.NUM_LIGNE_REJET);

                        if(TypeClientManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, TypeClientManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, TypeClientManquant.LB_CHEMIN_FICHIER);
}

                        if(TypeClientManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, TypeClientManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_1.setInt(3, TypeClientManquant.NUM_LIGNE_REJET);

                        if(TypeClientManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, TypeClientManquant.LB_LIGNE_REJET);
}

                        if(TypeClientManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, TypeClientManquant.LB_MESSAGE_REJET);
}

                        if(TypeClientManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, TypeClientManquant.LB_NOM_FLUX);
}

                        if(TypeClientManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(TypeClientManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, TypeClientManquant.LB_JOB_NAME);
}
...
} // End of branch "TypeClientManquant"
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"VerifTypeClient");
			  	}
...
globalMap.put("tDBOutput_2_ERROR_MESSAGE",e_tDBOutput_2.getMessage());
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertClient");
			  	}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertNewValueClient");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"TypeClientManquant");
			  	}
 ...
 */
	...
	System.err.println("Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Client. Veuillez déposer le fichier du jour et relancer l'intégration" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Client. Veuillez déposer le fichier du jour et relancer l'intégration" );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Client. Veuillez déposer le fichier du jour et relancer l'intégration" );
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(VerifTypeClient,TypeClientManquant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(VerifTypeClient,row7) outputs:(insertClient,updateBlCurrent,insertNewValueClient)
...
/************************************************************************************************
 *     411585 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:43:58 WAT
 ************************************************************************************************/