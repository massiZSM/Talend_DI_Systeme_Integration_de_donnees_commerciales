...
/**
 * Job: jOdsVente Purpose: Alimenter la table ODS_VENTE<br>
 * Description: Alimenter la table ODS_VENTE <br>
...
public static class venteExistantStruct implements routines.system.IPersistableRow<venteExistantStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final venteExistantStruct other = (venteExistantStruct) obj;
	...
	public void copyDataTo(venteExistantStruct other) {
	...
	public void copyKeysDataTo(venteExistantStruct other) {
...
public static class VerifClientStruct implements routines.system.IPersistableRow<VerifClientStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(VerifClientStruct other) {
...
public static class ClientManquantStruct implements routines.system.IPersistableRow<ClientManquantStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ClientManquantStruct other = (ClientManquantStruct) obj;
	...
	public void copyDataTo(ClientManquantStruct other) {
	...
	public void copyKeysDataTo(ClientManquantStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(ClientManquantStruct other) {
...
public static class VerifProduitStruct implements routines.system.IPersistableRow<VerifProduitStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(VerifProduitStruct other) {
...
public static class ProduitManquantStruct implements routines.system.IPersistableRow<ProduitManquantStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ProduitManquantStruct other = (ProduitManquantStruct) obj;
	...
	public void copyDataTo(ProduitManquantStruct other) {
	...
	public void copyKeysDataTo(ProduitManquantStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(ProduitManquantStruct other) {
...
VerifProduitStruct VerifProduit = new VerifProduitStruct();
VerifClientStruct VerifClient = new VerifClientStruct();
insertVenteStruct insertVente = new insertVenteStruct();
venteExistantStruct venteExistant = new venteExistantStruct();
ClientManquantStruct ClientManquant = new ClientManquantStruct();
ProduitManquantStruct ProduitManquant = new ProduitManquantStruct();
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"ID_VENTE\",\"CD_PRODUIT\",\"DT_VENTE\",\"ID_CLIENT\",\"QTE_VENTE\",\"PRIX_ACHAT\",\"PRIX_VENTE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tMap_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"VerifClient");
					}
 ...
 */
	...
	currentComponent="tDBOutput_7";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ClientManquant");
					}
...
if(dbschema_tDBOutput_7 == null || dbschema_tDBOutput_7.trim().length() == 0) {
	...
	tableName_tDBOutput_7 = dbschema_tDBOutput_7 + "\".\"" + ("ODS_REJET");
        ...
        int updateKeyCount_tDBOutput_7 = 4;
        if(updateKeyCount_tDBOutput_7 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_7 == 8 && true) {
...
int count_tDBOutput_7=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_7 = conn_tDBOutput_7.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_7 + "\" WHERE \"LB_CHEMIN_FICHIER\" = ? AND \"LB_NOM_FICHIER\" = ? AND \"NUM_LIGNE_REJET\" = ? AND \"LB_LIGNE_REJET\" = ?");
	    ...
	    String update_tDBOutput_7 = "UPDATE \"" + tableName_tDBOutput_7 + "\" SET \"LB_MESSAGE_REJET\" = ?,\"LB_NOM_FLUX\" = ?,\"DT_REJET\" = ?,\"LB_JOB_NAME\" = ? WHERE \"LB_CHEMIN_FICHIER\" = ? AND \"LB_NOM_FICHIER\" = ? AND \"NUM_LIGNE_REJET\" = ? AND \"LB_LIGNE_REJET\" = ?";
 ...
 */
	...
	currentComponent="tMap_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"VerifProduit");
					}
...
// ###############################
// # Outputs initialization
VerifClientStruct VerifClient_tmp = new VerifClientStruct();
ClientManquantStruct ClientManquant_tmp = new ClientManquantStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ProduitManquant");
					}
...
// ###############################
// # Outputs initialization
VerifProduitStruct VerifProduit_tmp = new VerifProduitStruct();
ProduitManquantStruct ProduitManquant_tmp = new ProduitManquantStruct();
// ###############################
...
// # Output table : 'Ventes'
Ventes_tmp.ID_VENTE = row1.ID_VENTE ;
Ventes_tmp.CD_PRODUIT = row1.CD_PRODUIT ;
Ventes_tmp.DT_VENTE = row1.DT_VENTE ;
Ventes_tmp.ID_CLIENT = row1.ID_CLIENT ;
Ventes_tmp.QTE_VENTE = row1.QTE_VENTE ;
Ventes_tmp.PRIX_ACHAT = row1.PRIX_ACHAT ;
Ventes_tmp.PRIX_VENTE = row1.PRIX_VENTE ;
Ventes_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1);
Ventes = Ventes_tmp;
// ###############################
...
if(Ventes != null) { 
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
      ope_tFilterRow_2.matches((// code sample : use Ventes to define the condition.
// Ventes.columnName1.equals("foo") ||!(Ventes.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
!Ventes.ID_VENTE.isEmpty() && 
!Ventes.CD_PRODUIT.isEmpty() &&
Ventes.DT_VENTE!=null &&
!Ventes.ID_CLIENT.isEmpty() &&
Ventes.QTE_VENTE!=null &&
Ventes.PRIX_ACHAT!=null &&
Ventes.PRIX_VENTE!=null
    ...
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.ID_VENTE = Ventes.ID_VENTE;
               row2.CD_PRODUIT = Ventes.CD_PRODUIT;
               row2.DT_VENTE = Ventes.DT_VENTE;
               row2.ID_CLIENT = Ventes.ID_CLIENT;
               row2.QTE_VENTE = Ventes.QTE_VENTE;
               row2.PRIX_ACHAT = Ventes.PRIX_ACHAT;
               row2.PRIX_VENTE = Ventes.PRIX_VENTE;
               row2.NUM_LIGNE = Ventes.NUM_LIGNE;    
      nb_line_ok_tFilterRow_2++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.ID_VENTE = Ventes.ID_VENTE;
                row5.CD_PRODUIT = Ventes.CD_PRODUIT;
                row5.DT_VENTE = Ventes.DT_VENTE;
                row5.ID_CLIENT = Ventes.ID_CLIENT;
                row5.QTE_VENTE = Ventes.QTE_VENTE;
                row5.PRIX_ACHAT = Ventes.PRIX_ACHAT;
                row5.PRIX_VENTE = Ventes.PRIX_VENTE;
                row5.NUM_LIGNE = Ventes.NUM_LIGNE;
...
VerifProduit = null;
ProduitManquant = null;

if(!rejectedInnerJoin_tMap_2 ) {

// # Output table : 'VerifProduit'
VerifProduit_tmp.ID_VENTE = row3.ID_VENTE ;
VerifProduit_tmp.CD_PRODUIT = row3.CD_PRODUIT ;
VerifProduit_tmp.DT_VENTE = row3.DT_VENTE ;
VerifProduit_tmp.ID_CLIENT = row3.ID_CLIENT ;
VerifProduit_tmp.QTE_VENTE = row3.QTE_VENTE ;
VerifProduit_tmp.PRIX_ACHAT = row3.PRIX_ACHAT ;
VerifProduit_tmp.PRIX_VENTE = row3.PRIX_VENTE ;
VerifProduit_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
VerifProduit = VerifProduit_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'ProduitManquant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
ProduitManquant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
ProduitManquant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
ProduitManquant_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
ProduitManquant_tmp.LB_LIGNE_REJET = row3.ID_VENTE+"|"+row3.CD_PRODUIT+"|"+row3.DT_VENTE+"|"+row3.ID_CLIENT+"|"+row3.QTE_VENTE+"|"+row3.PRIX_ACHAT+"|"+row3.PRIX_VENTE ;
ProduitManquant_tmp.LB_MESSAGE_REJET = "Dépendance ==> Le code produit : "+row3.CD_PRODUIT+" n'existe pas dans la table ODS_PRODUIT" ;
ProduitManquant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
ProduitManquant_tmp.DT_REJET = TalendDate.getCurrentDate() ;
ProduitManquant_tmp.LB_JOB_NAME = jobName;
ProduitManquant = ProduitManquant_tmp;
 					    ...
 					    boolean forceLooprow8 = false;
 							...
 							row8Struct row8ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_6 = false;
                        		    		    ...
                        		    		    row8HashKey.ID_CLIENT = VerifProduit.ID_CLIENT ;
...
// # Output table : 'VerifClient'
VerifClient_tmp.ID_VENTE = VerifProduit.ID_VENTE ;
VerifClient_tmp.CD_PRODUIT = VerifProduit.CD_PRODUIT ;
VerifClient_tmp.DT_VENTE = VerifProduit.DT_VENTE ;
VerifClient_tmp.ID_CLIENT = VerifProduit.ID_CLIENT ;
VerifClient_tmp.QTE_VENTE = VerifProduit.QTE_VENTE ;
VerifClient_tmp.PRIX_ACHAT = VerifProduit.PRIX_ACHAT ;
VerifClient_tmp.PRIX_VENTE = VerifProduit.PRIX_VENTE ;
VerifClient_tmp.NUM_LIGNE = VerifProduit.NUM_LIGNE ;
VerifClient = VerifClient_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'ClientManquant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_6 ) {
ClientManquant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
ClientManquant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
ClientManquant_tmp.NUM_LIGNE_REJET = VerifProduit.NUM_LIGNE ;
ClientManquant_tmp.LB_LIGNE_REJET = VerifProduit.ID_VENTE+"|"+VerifProduit.CD_PRODUIT+"|"+VerifProduit.DT_VENTE+"|"+VerifProduit.ID_CLIENT+"|"+VerifProduit.QTE_VENTE+"|"+VerifProduit.PRIX_ACHAT+"|"+VerifProduit.PRIX_VENTE ;
ClientManquant_tmp.LB_MESSAGE_REJET = "Dépendance ==> Le code client : "+VerifProduit.ID_CLIENT+" n'existe pas dans la table ODS_CLIENT" ;
ClientManquant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
ClientManquant_tmp.DT_REJET = TalendDate.getCurrentDate() ;
ClientManquant_tmp.LB_JOB_NAME = jobName;
ClientManquant = ClientManquant_tmp;
} // closing filter/reject
// ###############################
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.ID_VENTE = VerifClient.ID_VENTE ;
                        		    		
                        		    		    row7HashKey.CD_PRODUIT = VerifClient.CD_PRODUIT ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.ID_VENTE = '" + row7HashKey.ID_VENTE + "', row7.CD_PRODUIT = '" + row7HashKey.CD_PRODUIT + "'");
								} // G 071
...
venteExistant_tmp.NUM_LIGNE_REJET = VerifClient.NUM_LIGNE ;
venteExistant_tmp.LB_LIGNE_REJET = VerifClient.ID_VENTE+"|"+VerifClient.CD_PRODUIT+"|"+VerifClient.DT_VENTE+"|"+VerifClient.ID_CLIENT+"|"+VerifClient.QTE_VENTE+"|"+VerifClient.PRIX_ACHAT+"|"+VerifClient.PRIX_VENTE ;
venteExistant_tmp.LB_MESSAGE_REJET = "Données déja insérée dans la table" ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
insertVente_tmp.ID_VENTE = VerifClient.ID_VENTE ;
insertVente_tmp.CD_PRODUIT = VerifClient.CD_PRODUIT ;
insertVente_tmp.DT_VENTE = VerifClient.DT_VENTE ;
insertVente_tmp.ID_CLIENT = VerifClient.ID_CLIENT ;
insertVente_tmp.QTE_VENTE = VerifClient.QTE_VENTE ;
insertVente_tmp.PRIX_ACHAT = VerifClient.PRIX_ACHAT ;
insertVente_tmp.PRIX_VENTE = VerifClient.PRIX_VENTE ;
insertVente_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
...
} else {pstmt_tDBOutput_2.setString(1, insertVente.ID_VENTE);
}

                    if(insertVente.CD_PRODUIT == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertVente.CD_PRODUIT);
}

                    if(insertVente.DT_VENTE != null) {
pstmt_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(insertVente.DT_VENTE.getTime()));
} else {
...
} else {pstmt_tDBOutput_2.setString(4, insertVente.ID_CLIENT);
}

                    pstmt_tDBOutput_2.setInt(5, insertVente.QTE_VENTE);

                    pstmt_tDBOutput_2.setBigDecimal(6, insertVente.PRIX_ACHAT);

                    pstmt_tDBOutput_2.setBigDecimal(7, insertVente.PRIX_VENTE);

                    if(insertVente.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, insertVente.LB_NOM_FICHIER);
}

                    if(insertVente.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(9, new java.sql.Timestamp(insertVente.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_2.setString(10, insertVente.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_6.setString(1, venteExistant.LB_CHEMIN_FICHIER);
}

                    if(venteExistant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, venteExistant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, venteExistant.NUM_LIGNE_REJET);

                    if(venteExistant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, venteExistant.LB_LIGNE_REJET);
}

                    if(venteExistant.LB_MESSAGE_REJET == null) {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(5, venteExistant.LB_MESSAGE_REJET);
}

                    if(venteExistant.LB_NOM_FLUX == null) {
pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(6, venteExistant.LB_NOM_FLUX);
}

                    if(venteExistant.DT_REJET != null) {
pstmt_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(venteExistant.DT_REJET.getTime()));
} else {
...
} else {pstmt_tDBOutput_6.setString(8, venteExistant.LB_JOB_NAME);
}
...
} // End of branch "VerifClient"




// Start of branch "ClientManquant"
if(ClientManquant != null) { 
	...
	currentComponent="tDBOutput_7";
        ...
        whetherReject_tDBOutput_7 = false;
                    if(ClientManquant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_7.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_7.setString(1, ClientManquant.LB_CHEMIN_FICHIER);
}

                    if(ClientManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_7.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_7.setString(2, ClientManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_7.setInt(3, ClientManquant.NUM_LIGNE_REJET);

                    if(ClientManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_7.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_7.setString(4, ClientManquant.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_7 > 0) {
                        if(ClientManquant.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_7.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(1, ClientManquant.LB_MESSAGE_REJET);
}

                        if(ClientManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_7.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(2, ClientManquant.LB_NOM_FLUX);
}

                        if(ClientManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_7.setTimestamp(3, new java.sql.Timestamp(ClientManquant.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_7.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(ClientManquant.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_7.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(4, ClientManquant.LB_JOB_NAME);
}

                        if(ClientManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_7.setNull(5 + count_tDBOutput_7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(5 + count_tDBOutput_7, ClientManquant.LB_CHEMIN_FICHIER);
}

                        if(ClientManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_7.setNull(6 + count_tDBOutput_7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(6 + count_tDBOutput_7, ClientManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_7.setInt(7 + count_tDBOutput_7, ClientManquant.NUM_LIGNE_REJET);

                        if(ClientManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_7.setNull(8 + count_tDBOutput_7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(8 + count_tDBOutput_7, ClientManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_7.setString(1, ClientManquant.LB_CHEMIN_FICHIER);
}

                        if(ClientManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_7.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_7.setString(2, ClientManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_7.setInt(3, ClientManquant.NUM_LIGNE_REJET);

                        if(ClientManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_7.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_7.setString(4, ClientManquant.LB_LIGNE_REJET);
}

                        if(ClientManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_7.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_7.setString(5, ClientManquant.LB_MESSAGE_REJET);
}

                        if(ClientManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_7.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_7.setString(6, ClientManquant.LB_NOM_FLUX);
}

                        if(ClientManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_7.setTimestamp(7, new java.sql.Timestamp(ClientManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_7.setString(8, ClientManquant.LB_JOB_NAME);
}
...
} // End of branch "VerifProduit"




// Start of branch "ProduitManquant"
if(ProduitManquant != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(ProduitManquant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, ProduitManquant.LB_CHEMIN_FICHIER);
}

                    if(ProduitManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ProduitManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_1.setInt(3, ProduitManquant.NUM_LIGNE_REJET);

                    if(ProduitManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, ProduitManquant.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(ProduitManquant.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, ProduitManquant.LB_MESSAGE_REJET);
}

                        if(ProduitManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, ProduitManquant.LB_NOM_FLUX);
}

                        if(ProduitManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(ProduitManquant.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(ProduitManquant.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, ProduitManquant.LB_JOB_NAME);
}

                        if(ProduitManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, ProduitManquant.LB_CHEMIN_FICHIER);
}

                        if(ProduitManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, ProduitManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1, ProduitManquant.NUM_LIGNE_REJET);

                        if(ProduitManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, ProduitManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, ProduitManquant.LB_CHEMIN_FICHIER);
}

                        if(ProduitManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, ProduitManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_1.setInt(3, ProduitManquant.NUM_LIGNE_REJET);

                        if(ProduitManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, ProduitManquant.LB_LIGNE_REJET);
}

                        if(ProduitManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, ProduitManquant.LB_MESSAGE_REJET);
}

                        if(ProduitManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, ProduitManquant.LB_NOM_FLUX);
}

                        if(ProduitManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(ProduitManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, ProduitManquant.LB_JOB_NAME);
}
...
insertDuplicate_tmp.LB_LIGNE_REJET = row6.ID_VENTE+"|"+row6.CD_PRODUIT+"|"+row6.DT_VENTE+"|"+row6.ID_CLIENT+"|"+row6.QTE_VENTE+"|"+row6.PRIX_ACHAT+"|"+row6.PRIX_VENTE ;
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"VerifProduit");
			  	}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"VerifClient");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_7=nb_line_rejected_tDBOutput_7 + rejectedCount_tDBOutput_7;
        ...
        globalMap.put("tDBOutput_7_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_7);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ClientManquant");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ProduitManquant");
			  	}
 ...
 */
	...
	System.err.println("Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Vente. Veuillez déposer le fichier du jour et relancer l'intégration" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Vente. Veuillez déposer le fichier du jour et relancer l'intégration" );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Vente. Veuillez déposer le fichier du jour et relancer l'intégration" );
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(VerifProduit,ProduitManquant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// source node:tDBInput_3 - inputs:(after_tFileInputDelimited_1) outputs:(row8,row8) | target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
			   		// linked node: tMap_6 - inputs:(VerifProduit,row8) outputs:(VerifClient,ClientManquant)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
        	...
        	row8.ID_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row8.NOM_CLIENT = null;
							} else {
	                         		
        	row8.NOM_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row8.PREN_CLIENT = null;
							} else {
	                         		
        	row8.PREN_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row8.CD_POSTAL_CLIENT = null;
							} else {
	                         		
        	row8.CD_POSTAL_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row8.VILLE_CLIENT = null;
							} else {
	                         		
        	row8.VILLE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								row8.PAYS_CLIENT = null;
							} else {
	                         		
        	row8.PAYS_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row8.REGION_CLIENT = null;
							} else {
	                         		
        	row8.REGION_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 7, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 8) {
								row8.CD_TYPE_CLIENT = null;
							} else {
	                         		
        	row8.CD_TYPE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 8, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 9) {
								row8.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row8.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_3, 9, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 10) {
								row8.DT_INSERTION = null;
							} else {
										
			row8.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 10);
		                    }
							if(colQtyInRs_tDBInput_3 < 11) {
								row8.BL_LIGNE_ACTIVE = 0;
							} else {
		                          
            row8.BL_LIGNE_ACTIVE = rs_tDBInput_3.getInt(11);
        	...
        	row8.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 12, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row8";
				...
				row8_HashRow.NOM_CLIENT = row8.NOM_CLIENT;
				
				row8_HashRow.PREN_CLIENT = row8.PREN_CLIENT;
				
				row8_HashRow.CD_POSTAL_CLIENT = row8.CD_POSTAL_CLIENT;
				
				row8_HashRow.VILLE_CLIENT = row8.VILLE_CLIENT;
				
				row8_HashRow.PAYS_CLIENT = row8.PAYS_CLIENT;
				
				row8_HashRow.REGION_CLIENT = row8.REGION_CLIENT;
				
				row8_HashRow.CD_TYPE_CLIENT = row8.CD_TYPE_CLIENT;
...
public static class row7Struct implements routines.system.IPersistableComparableLookupRow<row7Struct> {
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.BL_LIGNE_IN_DWH = objectIn.readBoolean();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeBoolean(this.BL_LIGNE_IN_DWH);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(VerifClient,row7) outputs:(insertVente,venteExistant)
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
        	...
        	row7.ID_VENTE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row7.CD_PRODUIT = null;
							} else {
	                         		
        	row7.CD_PRODUIT = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row7.DT_VENTE = null;
							} else {
										
			row7.DT_VENTE = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 3);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row7.ID_CLIENT = null;
							} else {
	                         		
        	row7.ID_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row7.QTE_VENTE = 0;
							} else {
		                          
            row7.QTE_VENTE = rs_tDBInput_2.getInt(5);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row7.PRIX_ACHAT = null;
							} else {
		                          
            row7.PRIX_ACHAT = rs_tDBInput_2.getBigDecimal(6);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 7) {
								row7.PRIX_VENTE = null;
							} else {
		                          
            row7.PRIX_VENTE = rs_tDBInput_2.getBigDecimal(7);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row7.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_2, 8, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 9) {
								row7.DT_INSERTION = null;
							} else {
										
			row7.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 9);
		                    }
							if(colQtyInRs_tDBInput_2 < 10) {
								row7.LB_JOB_NAME = null;
							} else {
	                         		
        	row7.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 10, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 11) {
								row7.BL_LIGNE_IN_DWH = false;
							} else {
	                         		
            row7.BL_LIGNE_IN_DWH = rs_tDBInput_2.getBoolean(11);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.ID_VENTE = row7.ID_VENTE;
				
				row7_HashRow.CD_PRODUIT = row7.CD_PRODUIT;
				
				row7_HashRow.DT_VENTE = row7.DT_VENTE;
				
				row7_HashRow.ID_CLIENT = row7.ID_CLIENT;
				
				row7_HashRow.QTE_VENTE = row7.QTE_VENTE;
				
				row7_HashRow.PRIX_ACHAT = row7.PRIX_ACHAT;
				
				row7_HashRow.PRIX_VENTE = row7.PRIX_VENTE;
				...
				row7_HashRow.BL_LIGNE_IN_DWH = row7.BL_LIGNE_IN_DWH;
...
/************************************************************************************************
 *     477310 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:44:00 WAT
 ************************************************************************************************/