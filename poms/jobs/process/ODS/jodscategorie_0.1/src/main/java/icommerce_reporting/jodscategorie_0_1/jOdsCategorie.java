...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("ODS_CATEGORIE");
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("ODS_CATEGORIE");
}
...
int count_tDBOutput_4=0;
	    String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4 + "\" SET \"BL_LIGNE_ACTIVE\" = ? WHERE \"CD_CATEGORIE\" = ?";
...
UpdateBICurrent_tmp.CD_CATEGORIE = row3.CD_CATEGORIE ;
...
if(UpdateBICurrent != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    pstmt_tDBOutput_4.setInt(1, UpdateBICurrent.BL_LIGNE_ACTIVE);

                    if(UpdateBICurrent.CD_CATEGORIE == null) {
pstmt_tDBOutput_4.setNull(2 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2 + count_tDBOutput_4, UpdateBICurrent.CD_CATEGORIE);
}
...
} else {pstmt_tDBOutput_3.setString(2, insertNewValuecategorie.LB_CATEGORIE);
}

                    if(insertNewValuecategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertNewValuecategorie.LB_NOM_FICHIER);
}

                    if(insertNewValuecategorie.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(insertNewValuecategorie.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_3.setString(6, insertNewValuecategorie.LB_JOB_NAME);
}
 ...
 */
	...
	System.err.println("le répertoire ne contien pas de fichier catégorie" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "le répertoire ne contien pas de fichier catégorie" );
	globalMap.put("tDie_1_DIE_MESSAGES", "le répertoire ne contien pas de fichier catégorie" );
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(insertCategorie,UpdateBICurrent,insertNewValuecategorie)
...
/************************************************************************************************
 *     312148 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:43:44 WAT
 ************************************************************************************************/