...
/**
 * Job: jAlimentationBDD Purpose: Job principal<br>
 * Description:  <br>
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jAlimentationBDD = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD.length) {
				if(length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD.length == 0) {
   					commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD = new byte[1024];
				} else {
   					commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jAlimentationBDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ICOMMERCE_REPORTING_jAlimentationBDD) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		icommerce_reporting.jchargeods_0_1.jChargeODS childJob_tRunJob_1 = new icommerce_reporting.jchargeods_0_1.jChargeODS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		icommerce_reporting.jchargedwh_0_1.jChargeDWH childJob_tRunJob_2 = new icommerce_reporting.jchargedwh_0_1.jChargeDWH();
	    // pass DataSources
...
/************************************************************************************************
 *     113331 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:44:11 WAT
 ************************************************************************************************/