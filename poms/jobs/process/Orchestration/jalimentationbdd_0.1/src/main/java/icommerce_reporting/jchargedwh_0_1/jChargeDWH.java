...
/**
 * Job: jChargeDWH Purpose: Lancement de tous les jobs DWH<br>
 * Description: Lancement de tous les jobs DWH <br>
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jChargeDWH = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jChargeDWH = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ICOMMERCE_REPORTING_jChargeDWH.length) {
				if(length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jChargeDWH.length == 0) {
   					commonByteArray_ICOMMERCE_REPORTING_jChargeDWH = new byte[1024];
				} else {
   					commonByteArray_ICOMMERCE_REPORTING_jChargeDWH = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jChargeDWH, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jChargeDWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ICOMMERCE_REPORTING_jChargeDWH, 0, length);
			strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jChargeDWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ICOMMERCE_REPORTING_jChargeDWH) {
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		icommerce_reporting.jdwhproduit_0_1.jDwhProduit childJob_tRunJob_2 = new icommerce_reporting.jdwhproduit_0_1.jDwhProduit();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_4 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    ...
                    parentContextMap_tRunJob_4.put("schema_dwh", context.schema_dwh);
                    paraList_tRunJob_4.add("--context_type " + "schema_dwh" + "=" + "id_String");
	...
	Object obj_tRunJob_4 = null;
		...
		icommerce_reporting.jdwhvente_0_1.jDwhVente childJob_tRunJob_4 = new icommerce_reporting.jdwhvente_0_1.jDwhVente();
	    // pass DataSources
...
/************************************************************************************************
 *     127451 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:44:09 WAT
 ************************************************************************************************/