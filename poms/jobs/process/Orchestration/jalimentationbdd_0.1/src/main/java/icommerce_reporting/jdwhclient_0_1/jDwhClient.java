...
/**
 * Job: jDwhClient Purpose: Alimentation de la table DIM_CLIENT<br>
 * Description: Alimentation de la table DIM_CLIENT <br>
...
public static class insertNewClientsStruct implements routines.system.IPersistableRow<insertNewClientsStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jDwhClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jDwhClient = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(insertNewClientsStruct other) {
...
insertNewClientsStruct insertNewClients = new insertNewClientsStruct();
 ...
 */
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertNewClients");
					}
...
insertNewClientsStruct insertNewClients_tmp = new insertNewClientsStruct();
// ###############################
...
updateBlCurrent_tmp.ID_DIM_CLIENT = row3.ID_DIM_CLIENT ;
updateBlCurrent_tmp.DT_MISE_A_JOUR = TalendDate.getCurrentDate();
updateBlCurrent_tmp.BL_LIGNE_ACTIVE = 0;
updateBlCurrent = updateBlCurrent_tmp;
} // closing filter/reject

// # Output table : 'insertNewClients'
// # Filter conditions 
if( 
...
insertNewClients_tmp.ID_CLIENT = clients.ID_CLIENT ;
insertNewClients_tmp.NOM_CLIENT = clients.NOM_CLIENT ;
insertNewClients_tmp.PREN_CLIENT = clients.PREN_CLIENT ;
insertNewClients_tmp.CD_POSTAL_CLIENT = clients.CD_POSTAL_CLIENT ;
insertNewClients_tmp.VILLE_CLIENT = clients.VILLE_CLIENT ;
insertNewClients_tmp.PAYS_CLIENT = clients.PAYS_CLIENT ;
insertNewClients_tmp.REGION_CLIENT = clients.REGION_CLIENT ;
insertNewClients_tmp.CD_TYPE_CLIENT = clients.CD_TYPE_CLIENT ;
insertNewClients_tmp.LB_TYPE_CLIENT = clients.LB_TYPE_CLIENT ;
insertNewClients_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertNewClients_tmp.BL_LIGNE_ACTIVE = 1 ;
insertNewClients_tmp.LB_JOB_NAME = clients.LB_JOB_NAME  ;
insertNewClients = insertNewClients_tmp;
} // closing filter/reject
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
insertClient_tmp.ID_CLIENT = clients.ID_CLIENT;
insertClient_tmp.NOM_CLIENT = clients.NOM_CLIENT;
insertClient_tmp.PREN_CLIENT = clients.PREN_CLIENT;
insertClient_tmp.CD_POSTAL_CLIENT = clients.CD_POSTAL_CLIENT;
insertClient_tmp.VILLE_CLIENT = clients.VILLE_CLIENT;
insertClient_tmp.PAYS_CLIENT = clients.PAYS_CLIENT;
insertClient_tmp.REGION_CLIENT = clients.REGION_CLIENT;
insertClient_tmp.CD_TYPE_CLIENT = clients.CD_TYPE_CLIENT;
insertClient_tmp.LB_TYPE_CLIENT = clients.LB_TYPE_CLIENT;
insertClient_tmp.DT_INSERTION = TalendDate.getCurrentDate();
insertClient_tmp.BL_LIGNE_ACTIVE = 1;
insertClient_tmp.LB_JOB_NAME = clients.LB_JOB_NAME ;
...
} else {pstmt_tDBOutput_1.setString(1, insertClient.ID_CLIENT);
}

                    if(insertClient.NOM_CLIENT == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insertClient.NOM_CLIENT);
}

                    if(insertClient.PREN_CLIENT == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, insertClient.PREN_CLIENT);
}

                    if(insertClient.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, insertClient.CD_POSTAL_CLIENT);
}

                    if(insertClient.VILLE_CLIENT == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, insertClient.VILLE_CLIENT);
}

                    if(insertClient.PAYS_CLIENT == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, insertClient.PAYS_CLIENT);
}

                    if(insertClient.REGION_CLIENT == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, insertClient.REGION_CLIENT);
}

                    if(insertClient.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, insertClient.CD_TYPE_CLIENT);
}

                    if(insertClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, insertClient.LB_TYPE_CLIENT);
}

                    if(insertClient.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(10, new java.sql.Timestamp(insertClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(11, insertClient.BL_LIGNE_ACTIVE);

                    if(insertClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, insertClient.LB_JOB_NAME);
}
...
if(updateBlCurrent != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(updateBlCurrent.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_2.setTimestamp(1, new java.sql.Timestamp(updateBlCurrent.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(2, updateBlCurrent.BL_LIGNE_ACTIVE);

                    pstmt_tDBOutput_2.setInt(3 + count_tDBOutput_2, updateBlCurrent.ID_DIM_CLIENT);
...
// Start of branch "insertNewClients"
if(insertNewClients != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(insertNewClients.ID_CLIENT == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, insertNewClients.ID_CLIENT);
}

                    if(insertNewClients.NOM_CLIENT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertNewClients.NOM_CLIENT);
}

                    if(insertNewClients.PREN_CLIENT == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertNewClients.PREN_CLIENT);
}

                    if(insertNewClients.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, insertNewClients.CD_POSTAL_CLIENT);
}

                    if(insertNewClients.VILLE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, insertNewClients.VILLE_CLIENT);
}

                    if(insertNewClients.PAYS_CLIENT == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, insertNewClients.PAYS_CLIENT);
}

                    if(insertNewClients.REGION_CLIENT == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, insertNewClients.REGION_CLIENT);
}

                    if(insertNewClients.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, insertNewClients.CD_TYPE_CLIENT);
}

                    if(insertNewClients.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, insertNewClients.LB_TYPE_CLIENT);
}

                    if(insertNewClients.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(insertNewClients.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(11, insertNewClients.BL_LIGNE_ACTIVE);

                    if(insertNewClients.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(12, insertNewClients.LB_JOB_NAME);
}
...
} // End of branch "insertNewClients"
...
globalMap.put("tDBOutput_3_ERROR_MESSAGE",e_tDBOutput_3.getMessage());
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertNewClients");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(clients,row3) outputs:(insertClient,updateBlCurrent,insertNewClients)
...
/************************************************************************************************
 *     259736 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:44:06 WAT
 ************************************************************************************************/