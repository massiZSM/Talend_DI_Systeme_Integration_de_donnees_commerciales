...
/**
 * Job: jOdsSousCategorie Purpose: Alimenter la table ODS_SOUS_CATEGORIE<br>
 * Description: Alimenter la table ODS_SOUS_CATEGORIE <br>
...
public static class insertSousCategorieStruct implements routines.system.IPersistableRow<insertSousCategorieStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public static class insertNewValueSousCategorieStruct implements routines.system.IPersistableRow<insertNewValueSousCategorieStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertNewValueSousCategorieStruct other = (insertNewValueSousCategorieStruct) obj;
	...
	public void copyDataTo(insertNewValueSousCategorieStruct other) {
	...
	public void copyKeysDataTo(insertNewValueSousCategorieStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertNewValueSousCategorieStruct other) {
...
public static class VerifCategorieStruct implements routines.system.IPersistableRow<VerifCategorieStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(VerifCategorieStruct other) {
...
public static class CategorieManquantStruct implements routines.system.IPersistableRow<CategorieManquantStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final CategorieManquantStruct other = (CategorieManquantStruct) obj;
	...
	public void copyDataTo(CategorieManquantStruct other) {
	...
	public void copyKeysDataTo(CategorieManquantStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(CategorieManquantStruct other) {
...
public static class SousCategoriesStruct implements routines.system.IPersistableRow<SousCategoriesStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(SousCategoriesStruct other) {
...
SousCategoriesStruct SousCategories = new SousCategoriesStruct();
row2Struct row2 = new row2Struct();
row3Struct row3 = new row3Struct();
VerifCategorieStruct VerifCategorie = new VerifCategorieStruct();
...
insertNewValueSousCategorieStruct insertNewValueSousCategorie = new insertNewValueSousCategorieStruct();
CategorieManquantStruct CategorieManquant = new CategorieManquantStruct();
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"BL_LIGNE_ACTIVE\" = ? WHERE \"CD_SOUS_CATEGORIE\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertNewValueSousCategorie");
					}
...
if(dbschema_tDBOutput_6 == null || dbschema_tDBOutput_6.trim().length() == 0) {
	tableName_tDBOutput_6 = ("ODS_SOUS_CATEGORIE");
} else {
	tableName_tDBOutput_6 = dbschema_tDBOutput_6 + "\".\"" + ("ODS_SOUS_CATEGORIE");
}
...
int count_tDBOutput_6=0;
	    String insert_tDBOutput_6 = "INSERT INTO \"" + tableName_tDBOutput_6 + "\" (\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tMap_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"VerifCategorie");
					}
...
insertNewValueSousCategorieStruct insertNewValueSousCategorie_tmp = new insertNewValueSousCategorieStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"CategorieManquant");
					}
...
// ###############################
// # Outputs initialization
VerifCategorieStruct VerifCategorie_tmp = new VerifCategorieStruct();
CategorieManquantStruct CategorieManquant_tmp = new CategorieManquantStruct();
// ###############################
 ...
 */
	...
	currentComponent="tFilterRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"SousCategories");
					}
...
// ###############################
// # Outputs initialization
SousCategoriesStruct SousCategories_tmp = new SousCategoriesStruct();
// ###############################
...
// # Output table : 'SousCategories'
SousCategories_tmp.CD_SOUS_CATEGORIE = row1.CD_SOUS_CATEGORIE ;
SousCategories_tmp.LB_SOUS_CATEGORIE = row1.LB_SOUS_CATEGORIE ;
SousCategories_tmp.CD_CATEGORIE = row1.CD_CATEGORIE ;
SousCategories_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1);
SousCategories = SousCategories_tmp;
// ###############################
 ...
 */
// Start of branch "SousCategories"
if(SousCategories != null) { 
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
      ope_tFilterRow_2.matches((// code sample : use SousCategories to define the condition.
// SousCategories.columnName1.equals("foo") ||!(SousCategories.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
!SousCategories.CD_SOUS_CATEGORIE.isEmpty() && 
!SousCategories.LB_SOUS_CATEGORIE.isEmpty() &&
!SousCategories.CD_CATEGORIE.isEmpty()), "advanced condition failed");
    
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(row2 == null){ 
                row2 = new row2Struct();
              }
               row2.CD_SOUS_CATEGORIE = SousCategories.CD_SOUS_CATEGORIE;
               row2.LB_SOUS_CATEGORIE = SousCategories.LB_SOUS_CATEGORIE;
               row2.CD_CATEGORIE = SousCategories.CD_CATEGORIE;
               row2.NUM_LIGNE = SousCategories.NUM_LIGNE;    
      nb_line_ok_tFilterRow_2++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.CD_SOUS_CATEGORIE = SousCategories.CD_SOUS_CATEGORIE;
                row5.LB_SOUS_CATEGORIE = SousCategories.LB_SOUS_CATEGORIE;
                row5.CD_CATEGORIE = SousCategories.CD_CATEGORIE;
                row5.NUM_LIGNE = SousCategories.NUM_LIGNE;
...
VerifCategorie = null;
CategorieManquant = null;

if(!rejectedInnerJoin_tMap_2 ) {

// # Output table : 'VerifCategorie'
VerifCategorie_tmp.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE ;
VerifCategorie_tmp.LB_SOUS_CATEGORIE = row3.LB_SOUS_CATEGORIE ;
VerifCategorie_tmp.CD_CATEGORIE = row3.CD_CATEGORIE ;
VerifCategorie_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
VerifCategorie = VerifCategorie_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'CategorieManquant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
CategorieManquant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
CategorieManquant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
CategorieManquant_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
CategorieManquant_tmp.LB_LIGNE_REJET = row3.CD_SOUS_CATEGORIE+"|"+row3.LB_SOUS_CATEGORIE+"|"+row3.CD_CATEGORIE ;
CategorieManquant_tmp.LB_MESSAGE_REJET = "Dépendance ==> La catégorie : "+row3.CD_CATEGORIE+" n'existe pas dans la table ODS_CATEGORIE" ;
CategorieManquant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
CategorieManquant_tmp.DT_REJET = TalendDate.getCurrentDate() ;
CategorieManquant_tmp.LB_JOB_NAME = jobName;
CategorieManquant = CategorieManquant_tmp;
 ...
 */
// Start of branch "VerifCategorie"
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_SOUS_CATEGORIE = VerifCategorie.CD_SOUS_CATEGORIE ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.CD_SOUS_CATEGORIE = '" + row7HashKey.CD_SOUS_CATEGORIE + "'");
								} // G 071
...
insertNewValueSousCategorie = null;
...
!VerifCategorie.LB_SOUS_CATEGORIE.equals(row7.LB_SOUS_CATEGORIE) ||  !VerifCategorie.CD_CATEGORIE.equals(row7.CD_CATEGORIE)

 ) {
updateBlCurrent_tmp.CD_SOUS_CATEGORIE = row7.CD_SOUS_CATEGORIE ;
updateBlCurrent_tmp.BL_LIGNE_ACTIVE = 0;
updateBlCurrent = updateBlCurrent_tmp;
} // closing filter/reject

// # Output table : 'insertNewValueSousCategorie'
// # Filter conditions 
if( 
...
insertNewValueSousCategorie_tmp.CD_SOUS_CATEGORIE = VerifCategorie.CD_SOUS_CATEGORIE ;
insertNewValueSousCategorie_tmp.LB_SOUS_CATEGORIE = VerifCategorie.LB_SOUS_CATEGORIE ;
insertNewValueSousCategorie_tmp.CD_CATEGORIE = VerifCategorie.CD_CATEGORIE ;
insertNewValueSousCategorie_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertNewValueSousCategorie_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertNewValueSousCategorie_tmp.BL_LIGNE_ACTIVE = 1;
insertNewValueSousCategorie_tmp.LB_JOB_NAME = jobName;
insertNewValueSousCategorie = insertNewValueSousCategorie_tmp;
} // closing filter/reject
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'insertSousCategorie'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
insertSousCategorie_tmp.CD_SOUS_CATEGORIE = VerifCategorie.CD_SOUS_CATEGORIE ;
insertSousCategorie_tmp.LB_SOUS_CATEGORIE = VerifCategorie.LB_SOUS_CATEGORIE ;
insertSousCategorie_tmp.CD_CATEGORIE = VerifCategorie.CD_CATEGORIE ;
insertSousCategorie_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
...
} else {pstmt_tDBOutput_2.setString(1, insertSousCategorie.CD_SOUS_CATEGORIE);
}

                    if(insertSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertSousCategorie.LB_SOUS_CATEGORIE);
}

                    if(insertSousCategorie.CD_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, insertSousCategorie.CD_CATEGORIE);
}

                    if(insertSousCategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, insertSousCategorie.LB_NOM_FICHIER);
}

                    if(insertSousCategorie.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(5, new java.sql.Timestamp(insertSousCategorie.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(6, insertSousCategorie.BL_LIGNE_ACTIVE);

                    if(insertSousCategorie.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, insertSousCategorie.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_3.setString(2 + count_tDBOutput_3, updateBlCurrent.CD_SOUS_CATEGORIE);
}
...
// Start of branch "insertNewValueSousCategorie"
if(insertNewValueSousCategorie != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(insertNewValueSousCategorie.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, insertNewValueSousCategorie.CD_SOUS_CATEGORIE);
}

                    if(insertNewValueSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, insertNewValueSousCategorie.LB_SOUS_CATEGORIE);
}

                    if(insertNewValueSousCategorie.CD_CATEGORIE == null) {
pstmt_tDBOutput_6.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(3, insertNewValueSousCategorie.CD_CATEGORIE);
}

                    if(insertNewValueSousCategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, insertNewValueSousCategorie.LB_NOM_FICHIER);
}

                    if(insertNewValueSousCategorie.DT_INSERTION != null) {
pstmt_tDBOutput_6.setTimestamp(5, new java.sql.Timestamp(insertNewValueSousCategorie.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_6.setInt(6, insertNewValueSousCategorie.BL_LIGNE_ACTIVE);

                    if(insertNewValueSousCategorie.LB_JOB_NAME == null) {
pstmt_tDBOutput_6.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(7, insertNewValueSousCategorie.LB_JOB_NAME);
}
...
} // End of branch "insertNewValueSousCategorie"
...
} // End of branch "VerifCategorie"




// Start of branch "CategorieManquant"
if(CategorieManquant != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(CategorieManquant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, CategorieManquant.LB_CHEMIN_FICHIER);
}

                    if(CategorieManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, CategorieManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_1.setInt(3, CategorieManquant.NUM_LIGNE_REJET);

                    if(CategorieManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, CategorieManquant.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(CategorieManquant.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, CategorieManquant.LB_MESSAGE_REJET);
}

                        if(CategorieManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, CategorieManquant.LB_NOM_FLUX);
}

                        if(CategorieManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(CategorieManquant.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(CategorieManquant.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, CategorieManquant.LB_JOB_NAME);
}

                        if(CategorieManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, CategorieManquant.LB_CHEMIN_FICHIER);
}

                        if(CategorieManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, CategorieManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1, CategorieManquant.NUM_LIGNE_REJET);

                        if(CategorieManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, CategorieManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, CategorieManquant.LB_CHEMIN_FICHIER);
}

                        if(CategorieManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, CategorieManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_1.setInt(3, CategorieManquant.NUM_LIGNE_REJET);

                        if(CategorieManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, CategorieManquant.LB_LIGNE_REJET);
}

                        if(CategorieManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, CategorieManquant.LB_MESSAGE_REJET);
}

                        if(CategorieManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, CategorieManquant.LB_NOM_FLUX);
}

                        if(CategorieManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(CategorieManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, CategorieManquant.LB_JOB_NAME);
}
...
} // End of branch "CategorieManquant"
...
insertDuplicate_tmp.LB_LIGNE_REJET = row6.CD_SOUS_CATEGORIE+"|"+row6.LB_SOUS_CATEGORIE ;
...
insertReject_tmp.LB_LIGNE_REJET = row5.CD_SOUS_CATEGORIE+"|"+row5.LB_SOUS_CATEGORIE ;
 ...
 */
    ...
    globalMap.put("tFilterRow_2_NB_LINE_REJECT", nb_line_reject_tFilterRow_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"SousCategories");
			  	}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"VerifCategorie");
			  	}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertNewValueSousCategorie");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"CategorieManquant");
			  	}
 ...
 */
	...
	System.err.println("Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier SousCategorie. Veuillez déposer le fichier du jour et relancer l'intégration" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier SousCategorie. Veuillez déposer le fichier du jour et relancer l'intégration" );
	globalMap.put("tDie_1_DIE_MESSAGES", "Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier SousCategorie. Veuillez déposer le fichier du jour et relancer l'intégration" );
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(VerifCategorie,CategorieManquant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(VerifCategorie,row7) outputs:(insertSousCategorie,updateBlCurrent,insertNewValueSousCategorie)
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
        	...
        	row7.CD_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row7.LB_SOUS_CATEGORIE = null;
							} else {
	                         		
        	row7.LB_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row7.CD_CATEGORIE = null;
							} else {
	                         		
        	row7.CD_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row7.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row7.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row7.DT_INSERTION = null;
							} else {
										
			row7.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 5);
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row7.BL_LIGNE_ACTIVE = 0;
							} else {
		                          
            row7.BL_LIGNE_ACTIVE = rs_tDBInput_2.getInt(6);
        	...
        	row7.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.LB_SOUS_CATEGORIE = row7.LB_SOUS_CATEGORIE;
...
/************************************************************************************************
 *     384865 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:43:51 WAT
 ************************************************************************************************/