...
public static class UpdateBICurrentStruct implements routines.system.IPersistableRow<UpdateBICurrentStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsTypeClient = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final UpdateBICurrentStruct other = (UpdateBICurrentStruct) obj;
	...
	public void copyDataTo(UpdateBICurrentStruct other) {
	...
	public void copyKeysDataTo(UpdateBICurrentStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(UpdateBICurrentStruct other) {
...
UpdateBICurrentStruct UpdateBICurrent = new UpdateBICurrentStruct();
 ...
 */
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"UpdateBICurrent");
					}
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"BL_LIGNE_ACTIVE\" = ? WHERE \"CD_TYPE_CLIENT\" = ?";
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("ODS_TYPE_CLIENT");
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("ODS_TYPE_CLIENT");
}
...
int count_tDBOutput_4=0;
	    String insert_tDBOutput_4 = "INSERT INTO \"" + tableName_tDBOutput_4 + "\" (\"CD_TYPE_CLIENT\",\"LB_TYPE_CLIENT\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?)";
...
UpdateBICurrentStruct UpdateBICurrent_tmp = new UpdateBICurrentStruct();
...
UpdateBICurrent_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
UpdateBICurrent_tmp.BL_LIGNE_ACTIVE = 0;
UpdateBICurrent = UpdateBICurrent_tmp;
...
insertNewValueTypeClient_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
insertNewValueTypeClient_tmp.LB_TYPE_CLIENT = row3.LB_TYPE_CLIENT ;
insertNewValueTypeClient_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
...
} else {pstmt_tDBOutput_1.setString(1, insertTypeClient.CD_TYPE_CLIENT);
}

                    if(insertTypeClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insertTypeClient.LB_TYPE_CLIENT);
}

                    if(insertTypeClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, insertTypeClient.LB_NOM_FICHIER);
}

                    if(insertTypeClient.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(insertTypeClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(5, insertTypeClient.BL_LIGNE_ACTIVE);

                    if(insertTypeClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, insertTypeClient.LB_JOB_NAME);
}
...
// Start of branch "UpdateBICurrent"
if(UpdateBICurrent != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    pstmt_tDBOutput_3.setInt(1, UpdateBICurrent.BL_LIGNE_ACTIVE);

                    if(UpdateBICurrent.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(2 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2 + count_tDBOutput_3, UpdateBICurrent.CD_TYPE_CLIENT);
}
...
} else {pstmt_tDBOutput_4.setString(1, insertNewValueTypeClient.CD_TYPE_CLIENT);
}

                    if(insertNewValueTypeClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, insertNewValueTypeClient.LB_TYPE_CLIENT);
}

                    if(insertNewValueTypeClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(3, insertNewValueTypeClient.LB_NOM_FICHIER);
}

                    if(insertNewValueTypeClient.DT_INSERTION != null) {
pstmt_tDBOutput_4.setTimestamp(4, new java.sql.Timestamp(insertNewValueTypeClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_4.setInt(5, insertNewValueTypeClient.BL_LIGNE_ACTIVE);

                    if(insertNewValueTypeClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6, insertNewValueTypeClient.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_2.setString(1, insertReject.LB_CHEMIN_FICHIER);
}

                    if(insertReject.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertReject.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_2.setInt(3, insertReject.NUM_LIGNE_REJET);

                    if(insertReject.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, insertReject.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_2.setString(1, insertReject.LB_MESSAGE_REJET);
}

                        if(insertReject.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2, insertReject.LB_NOM_FLUX);
}

                        if(insertReject.DT_REJET != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(insertReject.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_2.setString(4, insertReject.LB_JOB_NAME);
}

                        if(insertReject.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(5 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(5 + count_tDBOutput_2, insertReject.LB_CHEMIN_FICHIER);
}

                        if(insertReject.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2, insertReject.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2, insertReject.NUM_LIGNE_REJET);

                        if(insertReject.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(8 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(8 + count_tDBOutput_2, insertReject.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, insertReject.LB_CHEMIN_FICHIER);
}

                        if(insertReject.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, insertReject.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_2.setInt(3, insertReject.NUM_LIGNE_REJET);

                        if(insertReject.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, insertReject.LB_LIGNE_REJET);
}

                        if(insertReject.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(5, insertReject.LB_MESSAGE_REJET);
}

                        if(insertReject.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(6, insertReject.LB_NOM_FLUX);
}

                        if(insertReject.DT_REJET != null) {
pstmtInsert_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(insertReject.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_2.setString(8, insertReject.LB_JOB_NAME);
}
...
globalMap.put("tDBOutput_3_ERROR_MESSAGE",e_tDBOutput_3.getMessage());
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"UpdateBICurrent");
			  	}
 ...
 */
	...
	System.err.println("le répertoire ne contien pas de fichier TYPE_CLIENT" );
	
	globalMap.put("tDie_1_DIE_MESSAGE", "le répertoire ne contien pas de fichier TYPE_CLIENT" );
	globalMap.put("tDie_1_DIE_MESSAGES", "le répertoire ne contien pas de fichier TYPE_CLIENT" );
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(insertTypeClient,UpdateBICurrent,insertNewValueTypeClient)
...
/************************************************************************************************
 *     314349 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 septembre 2023 à 12:43:56 WAT
 ************************************************************************************************/